...
int
log_send_local_data(search_state_t *sc, int conn)
{
...
int
log_send_queued_data(search_state_t *sc, log_info_t *log_info, int conn)
{
...
void
update_device_log_level(search_state_t *sc)
{
...
void
set_device_log(log_set_level_t *llevel, search_state_t *sc)
{
	device_handle_t *cur_dev;
...
void
process_log_data(search_state_t *sc, int conn)
{
	log_info_t *linfo;
